...
from Utils import DNT_oficinas, QR_Code, analise_google,Dimmy_Dash, PosDash, validar_fotos
...
if check_authentication():
    ...
    with st.sidebar:
        escolha = option_menu("Menu", ["DNT oficinas", "QR Code", "Analise Google", "Validar Fotos", "Pos Dash"],
    ...
    if escolha == "Validar Fotos":
        validar_fotos.carregar() 
    if escolha == "Pos Dash":
        PosDash.carregar()
    if escolha == "Sair":
        logout()
